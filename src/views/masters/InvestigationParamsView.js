...
const InvestigationParamsView = (props) => {
  const addButtonText = "Add Investigation Params";
  ...
  useEffect(() => {
    ...
    listAll("investigation_params", q).then((res) => {
  ...
  // On record delete
  const onRowDelete = () => {
    deletePage("investigation_params", deleteRowId).then((res) => {
...
const AddForm = (props) => {
  ...
  useEffect(() => {
    listAll("investigation_types").then((res) => {
  ...
  const onSubmit = (data) => {
    ...
    create("investigation_params", saveData).then((res) => {
  ...
  return (
    ...
    >
      <Modal.Header closeButton>
        <Modal.Title>Add Investigation Params</Modal.Title>
      </Modal.Header>
      <Modal.Body>
...
const EditForm = (props) => {
  ...
  useEffect(() => {
    ...
    viewPage("investigation_params", rowId).then((res) => {
      setRowInfo(res.data);
  ...
  const onSubmit = (data) => {
    ...
    update("investigation_params", saveData, rowId).then((res) => {
      handleCloseAndReload();
    }).catch((err) => {
      NotificationManager.error(COMMON_MESSAGES.SOMETHING_WRONG, 'Error', 5000);
    });
  ...
  return (
    ...
    >
      <Modal.Header closeButton>
        <Modal.Title>Edit Investigation Params</Modal.Title>
      </Modal.Header>
      <Modal.Body>
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="form-group">
...
export default InvestigationParamsView;
