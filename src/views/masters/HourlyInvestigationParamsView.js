...
const HourlyInvestigationParamsView = (props) => {
  const addButtonText = "Add Hourly Investigation Params";
  ...
  useEffect(() => {
    ...
    listAll("hourly_investigation_params", q).then((res) => {
  ...
  // On record delete
  const onRowDelete = () => {
    deletePage("hourly_investigation_params", deleteRowId).then((res) => {
...
const AddForm = (props) => {
  ...
  useEffect(() => {
    listAll("hourly_investigation_types").then((res) => {
  ...
  const onSubmit = (data) => {
    ...
    create("hourly_investigation_params", saveData).then((res) => {
  ...
  return (
    ...
    >
      <Modal.Header closeButton>
        <Modal.Title>Add Hourly Investigation Params</Modal.Title>
      </Modal.Header>
      <Modal.Body>
...
const EditForm = (props) => {
  ...
  useEffect(() => {
    ...
    viewPage("hourly_investigation_params", rowId).then((res) => {
      setRowInfo(res.data);
  ...
  const onSubmit = (data) => {
    ...
    update("hourly_investigation_params", saveData, rowId).then((res) => {
      handleCloseAndReload();
    }).catch((err) => {
      NotificationManager.error(COMMON_MESSAGES.SOMETHING_WRONG, 'Error', 5000);
    });
  ...
  return (
    ...
    >
      <Modal.Header closeButton>
        <Modal.Title>Edit Hourly Investigation Params</Modal.Title>
      </Modal.Header>
      <Modal.Body>
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="form-group">
...
export default HourlyInvestigationParamsView;
