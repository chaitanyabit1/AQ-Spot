...
const ExaminationParamsView = (props) => {
  const addButtonText = "Add New Examination Params";
  ...
  useEffect(() => {
    ...
    listAll("examination_params", q).then((res) => {
  ...
  // On record delete
  const onRowDelete = () => {
    deletePage("examination_params", deleteRowId).then((res) => {
...
const AddForm = (props) => {
  ...
  useEffect(() => {
    listAll("examination_types").then((res) => {
  ...
  const onSubmit = (data) => {
    ...
    create("examination_params", saveData).then((res) => {
  ...
  return (
    ...
    >
      <Modal.Header closeButton>
        <Modal.Title>Add Examination Params</Modal.Title>
      </Modal.Header>
      <Modal.Body>
...
const EditForm = (props) => {
  ...
  useEffect(() => {
    ...
    viewPage("examination_params", rowId).then((res) => {
      setRowInfo(res.data);
  ...
  const onSubmit = (data) => {
    ...
    update("examination_params", saveData, rowId).then((res) => {
      handleCloseAndReload();
    }).catch((err) => {
      NotificationManager.error(COMMON_MESSAGES.SOMETHING_WRONG, 'Error', 5000);
    });
  ...
  return (
    ...
    >
      <Modal.Header closeButton>
        <Modal.Title>Edit Examination Params</Modal.Title>
      </Modal.Header>
      <Modal.Body>
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="form-group">
...
export default ExaminationParamsView;
