...
import { listAll, deleteRow } from "../../services/UsersService";
        ...
        <div className="row justify-content-center mb-3">
          <div className="col-12">
            <div className="row align-items-center">
              ...
              {(getUserAccesses().includes(USER_RESTRICT_ROUTE.USER_ADD) || [USER_TYPE.SUPER_ADMIN, USER_TYPE.CCC_DOCTOR].includes(getUserDetails().user_type)) &&
                <Link to={RoutePaths.USERS_ADD}>
